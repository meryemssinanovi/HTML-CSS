...
console.log(Number(" 34 ")); // 34 - brise  razmakse sa strana i prevodi rec u broj
...
console.log(parseFloat(" 34 ")); //34 - brise  razmakse sa strana i prevodi rec u broj

console.log(parseFloat(" 34 43 ")); // Razmaci su dozvoljeni.Parsira se samo prva vrednost.
...
console.log(parseInt("34.456")); // 34.456

console.log(parseInt(" 34 ")); //34 - brise  razmakse sa strana i prevodi rec u broj

console.log(parseInt(" 34 43 ")); // Razmaci su dozvoljeni.Parsira se samo prva vrednost.
...
// Napraviti funciju koja:

// a) pretvra km u m

// b) prestvara m u km
// c) prestvara inch u cm
